...
## Linear Rregression Valuation Methodology
### A. Algorithms
In order to predict player market value, I employed a multiple linear regression algorithm. I utilized the Python scikit-learn function, sklearn.linear_model._base.LinearRegression, to perform the prediction.
